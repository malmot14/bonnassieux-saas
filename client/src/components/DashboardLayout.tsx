...
const menuItems = [
  ...
  { icon: Heart, label: "Coaching Mental", path: "/coaching" },
];
...
export default function DashboardLayout({
  ...
  // AUTH BYPASS — guards désactivés temporairement
            ...
            <div className="flex items-center gap-3 px-2 transition-all w-full">
              ...
              {!isCollapsed ? (
                <div className="flex items-center gap-2 min-w-0">
                  <img src="/bonnassieux_moderne-removebg-preview.png" alt="Bonnassieux" className="h-8 w-auto" onError={(e) => { (e.target as HTMLImageElement).style.display='none'; }} />
                </div>
              ) : null}
            </div>
          </SidebarHeader>
